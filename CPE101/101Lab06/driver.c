...
/* Prototype for function written by student */
...
static void displayResults(char p[MAX][MAX], char s[MAX][MAX], int rows, int cols)
{
   ...
   if (matches)
   {
      ...
      printf("Be aware that any restictions on the number of if, else, and\n");
      printf("logical operators specified by the problem were not checked.\n");
      printf("Verify that your solution meets any such restrictions before\n");
      printf("moving on.\n\n");
      return;
   }
