...
public class HashChainingAcceptanceTests
{
   private static final Class cls = HashChaining.class;
   ...
   {
      HashChaining<Integer> tbl = new HashChaining<Integer>(100);
   ...
   public void maxCollisions()
   {
      ...
      tbl = new HashChaining<Integer>(12);
   ...
   {
      HashChaining<Integer> tbl = new HashChaining<Integer>(12);
   ...
   {
      int size = 10000;
      HashChaining<Double> tbl = new HashChaining<Double>(2 * size);
